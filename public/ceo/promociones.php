            ...
            <div class="container shadow-lg p-3 bg-body rounded">
                ...
                <div class="row align-items-center mx-auto">
                    <div class="col-md-12 d-flex justify-content-around m-auto ">
                        <a href="crearPromocion.php" class="btn btn-primary">Crear Promoción</a>
                        ...
                        <div class="row m-auto">
                            ...
                            foreach ($promociones as $promocion): ?>
                                <div class="col-md-4 col-6 mb-4">
                                    <a href="opcionesPromocion.php?idPromocion=<?php echo $promocion['idPromo'] ?>" class="text-decoration-none">
                                        <div class="card">
                                            <div class="card-body">
