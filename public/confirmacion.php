        ...
        <div class="bg-primary-subtle py-3">
            <div class="shadow-lg p-3 mb-5 bg-body rounded container">
                ...
                <div class="d-flex justify-content-center align-items-center gap-2 py-3">
                    ...
                    <hr class="border-secondary opacity-75 m-0" id="linea2" style="width: 36px;">
                ...
                <div class="row justify-content-center my-5">
                    <div class="col-md-6">
                        <div class="card p-4 text-center">
                            <p class="text-center">¡Tu cuenta ha sido verificada exitosamente!</p>
                            <p class="text-muted small">Ahora puedes iniciar sesión y comenzar a reservar vuelos.</p>
